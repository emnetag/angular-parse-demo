...
angular.module('ToDoApp', ['ui.bootstrap'])
    .config(function($httpProvider) {
        ...
        $httpProvider.defaults.headers.common['X-Parse-Application-Id'] = 'Yoe8nkUkeM2fPgKyNk8RGiMk5ilr86pehJXUDCuZ';
        $httpProvider.defaults.headers.common['X-Parse-REST-API-Key'] = 'zGcFbGdMpT8fzbfWxT6Vsqq1s0Mlqr9iPelEBtGt';
    })
